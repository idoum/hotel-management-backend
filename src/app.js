...
// Importation des routes staff-security
...
// Importation des routes accommodation (hébergement)
...
// Importation des routes restaurant
...
// Synchronisation base Sequelize au démarrage
sequelize.authenticate()
  .then(() => {
    console.log('✅ Connexion à MySQL réussie');
    return sequelize.sync(); // Synchronisation modèles
  })
